...
final class LongVideoController extends AdminController
{
    ...
    public function list(): Page
    {
        $crud = $this->baseCRUD()
            ...
            ->columns([
                ...
                TableColumn::make()->name('is_uncensored')->label('有无码'),
                ...
                TableColumn::make()->name('subtitles')->label('字幕'),
    ...
    public function form(): Form
    {
        return $this->baseForm()->body([
            ...
            TextControl::make()->name('is_uncensored')->label('有无码'),
            TextControl::make()->name('type')->label('原编码类型'),
            TextControl::make()->name('subtitles')->label('字幕'),
    ...
    public function detail(): Form
    {
        return $this->baseDetail()->body([
            ...
            TextControl::make()->static(true)->name('subtitles')->label('字幕'),
            ...
            TextControl::make()->static(true)->name('is_uncensored')->label('有无码'),
